...
function BorderFavorites(params) {
    ...
    return (
        <div className='container'>
            <div className="d-flex justify-content-between">
                <h3 className='mt-5'>{t("favorites")}</h3>
                <button className="btn btn-outline-success cleare" onClick={(e) => clearFavorites(e)}>{t("clear")}</button>
            </div>
            ...
            <div className="load">   <button className="btn btn-primary loadmore mt-4" onClick={showMoreItems}>{t("daha çox")}</button></div>

        </div>
    )
}

export default BorderFavorites