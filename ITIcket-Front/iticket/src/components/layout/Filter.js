                ...
                <div className="col-lg-4 col-md-6 col-sm-12">
                    <div className='filter'>
                        ...
                        >
                            ...
                            <input type="text" className='date-range flatpickr-input' placeholder={t("date")} data-input />
                        </Flatpickr>
                    </div>
                </div>
                <div className="col-lg-4 col-md-6 col-sm-12">
                    <div className='filter'>
                        <div className='price-range-view'> {t("qiymet")} {props.getPrice[0]} ₼-dan {props.getPrice[1]} ₼-dək</div>
                        <Box sx={{ width: '100%' }}>
                            <Slider
                                sx={{ width: '50%' }}
